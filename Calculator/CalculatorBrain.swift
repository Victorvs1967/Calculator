...
struct CalculatorBrain {
   ...
   private var operations: Dictionary<String, Operation> = [
      ...
      "cos⁻¹": Operation.unaryOperation(acos, nil, { -1 < $0 || $0 < 1 ? "invalid argument" : nil }),
      "sin⁻¹": Operation.unaryOperation(asin, nil, { -1 < $0 || $0 < 1 ? "invalid argument" : nil }),
      ...
      "ln": Operation.unaryOperation(log, nil, { $0 < 0 ? "negative operand" : nil }),
